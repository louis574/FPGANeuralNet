...
REM
REM Generated by Vivado on Fri Jul 18 00:14:02 +0100 2025
...
echo "xvlog --incr --relax -prj weight_mem_tb_vlog.prj"
call xvlog  --incr --relax -prj weight_mem_tb_vlog.prj -log xvlog.log
